      ...
      <div className="w-full max-w-[430px] mx-auto">
        <div className="mx-4 mb-4 bg-white/90 backdrop-blur-xl rounded-[28px] shadow-[0_8px_32px_rgba(0,0,0,0.12),0_4px_16px_rgba(0,0,0,0.08)] border border-[#F0EBE5]">
          <div className="flex items-center justify-around h-16 px-2">
              ...
              return (
                ...
                >
                  <div className={`flex flex-col items-center justify-center transition-all rounded-xl px-3 py-2 ${
                    isActive ? 'bg-gradient-to-br from-[#8D123F] to-[#A8224E] text-white shadow-[0_4px_12px_rgba(141,18,63,0.3)]' : 'text-[#4B3028]/60 group-hover:text-[#8D123F] group-hover:bg-[#F4D8CC]/50'
                  }`}>
            ...
            >
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#8D123F] to-[#A8224E] flex items-center justify-center shadow-[0_8px_24px_rgba(141,18,63,0.4),0_4px_12px_rgba(141,18,63,0.3)] border-4 border-white">

...
import { ShoppingBag, Clock, Plus, X } from 'lucide-react'
...
interface FavoriteOrdersSheetProps {
  isOpen: boolean
  onClose: () => void
}

export function FavoriteOrdersSheet({ isOpen, onClose }: FavoriteOrdersSheetProps) {
  ...
  return (
    <div className="px-5 pt-4 pb-6 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-[20px] font-bold" style={{ color: '#24364B' }}>Favourite Orders</h2>
